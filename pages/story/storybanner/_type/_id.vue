...
export default {
  data() {
    return {
      ...
      items: [
        ...
        {
          text: "Story Banner",
          href: "/story/storybanner",
        },
        {
          text: "Edit Story Banner",
          active: true,
        },
      ],
      loaded: false,
  ...
  methods: {
    getMainStory() {
      ...
      if (id) {
          this.$store.dispatch("story/getMainStory", this.form.locale).then((response) => {
    ...
    async update() {
        ...
        if (id) {
          ...
          this.$axios.put(`/api/story-main-banner`, formData)
            .then(() => {
